...
inoremap <C-L> 
inoremap <C-]> 
inoremap <C-F> :call JoinLine()A
inoremap <C-Q> :
inoremap <F8> =ListMonths()
inoremap <F2> <CTRL-E>
map! <S-Insert> *
nnoremap  :call me#Compile()
nnoremap  :Dox
snoremap <silent>  "_c
...
nnoremap  g :call SwitchGui()
nnoremap  q :
nnoremap  e :call me#GenerateDefine()
nnoremap  i :call me#CreateImplement()
nnoremap  md :tabnew $HOME/vimfiles/pack/MyVim
nnoremap  mo :browse oldfiles
nnoremap  mr :set nornu
nnoremap  ms :set foldmethod=syntax
nnoremap  o :tabnew $MYVIMRC
nnoremap  c :!start cmd
nnoremap  t T
nnoremap  z ZZ
nmap - <Plug>PopupMenu
xmap - <Plug>PopupMenu
...
nmap cs <Plug>Csurround
nnoremap cx :call CopyLine()
nmap ds <Plug>Dsurround
xmap gx <Plug>NetrwBrowseXVis
nmap gx <Plug>NetrwBrowseX
xmap gS <Plug>VgSurround
nnoremap gs :call OnlyTab()
...
map <SNR>72_SIDGenerateDoxygen :call me#GenerateDoxygenComment()
map <SNR>72_Implement :call me#CreateImplement()
map <SNR>72_SIDDelimate :call me#Delimate()
...
nnoremap <C-S> :w
nnoremap <C-B> :call me#Compile()
nnoremap <C-N> :bel vnew
nnoremap <C-Q> :
nnoremap <M-w> 
nnoremap <F10> :wqa
nnoremap <F9> :Tagbar
...
set dictionary=~/vimfiles/complete/dictionary/cpp-std.txt,~/vimfiles/complete/dictionary/add_to_dict_from_editing.txt,~/vimfiles/complete/dictionary/cpp-keywords.txt,~/vimfiles/complete/dictionary/cpp-std-header.txt,~/vimfiles/complete/dictionary/qtbase-dict.txt,~/vimfiles/tmp/CMakeLists.txt,~/vimfiles/complete/cmake_command.txt,~/vimfiles/complete/cmake_keyword.txt
set expandtab
set fileencodings=utf-8,gbk
set guicursor=a:block-blinkon0,i:blinkwait200-blinkoff150-blinkon200-CursorInsert,r:CursorReplace,v:CursorVisual,c:ver30-blinkon300-CursorInsert
...
set runtimepath+=~\\vimfiles\\pack\\MyVim\\start\\PlugTest
set runtimepath+=~\\vimfiles\\pack\\MyVim\\start\\me
set runtimepath+=~\\vimfiles\\pack\\MyVim\\start\\linlin-popup-menu
set runtimepath+=~\\.vim\\plugged\\rainbow_csv
set runtimepath+=~\\.vim\\plugged\\context.vim
set runtimepath+=~\\.vim\\plugged\\lightline.vim
set runtimepath+=~\\.vim\\plugged\\vim-snake
...
set runtimepath+=~\\.vim\\plugged\\DoxygenToolkit.vim
...
set runtimepath+=D:\\Program\ Files\\Vim/vimfiles
set runtimepath+=D:\\Program\ Files\\Vim\\vim90
set runtimepath+=D:\\Program\ Files\\Vim/vimfiles/after
set runtimepath+=~\\.vim\\plugged\\ultisnips\\after
set runtimepath+=~\\.vim\\plugged\\awesome-vim-colorschemes\\after
set runtimepath+=~/vimfiles/after
set runtimepath+=~\\.vim\\UltiSnips
set runtimepath+=~\\.vim
set runtimepath+=~/vimfiles/bitmaps
set scrolloff=5
set shell=pwsh
...
set tabstop=4
set tags=./tags,tags,D:/Qt/6.5.0/Src/widgets/tags
set textwidth=80
...
silent only
silent tabonly
cd D:\user\code\practice\cpp\basic\template
...
badd +10 pack_expansions.cpp
badd +20 parameter.cpp
badd +185 pp_parameter_pack.cpp
badd +16 pp_first_specific.cpp
badd +31 check-use-template-para-check.cpp
argglobal
%argdel
argglobal
enew
